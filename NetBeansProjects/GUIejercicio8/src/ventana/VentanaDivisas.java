...
public class VentanaDivisas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Calculadora Divisas");
        setPreferredSize(new java.awt.Dimension(212, 317));
        ...
        etiquetaCambio1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 36)); // NOI18N
        ...
        comboDivisas1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        comboDivisas1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estados Unidos - Dolar", "Perú - Nuevo Sol", "Colombia - Peso", "Europa - Euro" }));
        ...
        etiquetaCambio2.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 36)); // NOI18N
        ...
        comboDivisas2.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        comboDivisas2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estados Unidos - Dolar", "Perú - Nuevo Sol", "Colombia - Peso", "Europa - Euro" }));
        ...
        botonC.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        botonC.setText("C");
        ...
        boton7.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        boton7.setText("7");
        ...
        boton8.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        boton8.setText("8");
        ...
        boton9.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        boton9.setText("9");
        ...
        calculadoraDivisas.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        calculadoraDivisas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/divisas.png"))); // NOI18N
        calculadoraDivisas.setText("Calculadora Divisas");
    ...
    private void cambioDivisa(){
        ...
        else if(divisa1.equals("Estados Unidos - Dolar") && divisa2.equals("Perú - Nuevo Sol")){
            cambio=3.88;
        }
        ...
        else if(divisa1.equals("Perú - Nuevo Sol") && divisa2.equals("Estados Unidos - Dolar")){
            cambio=0.26;
        }
        else if(divisa1.equals("Perú - Nuevo Sol") && divisa2.equals("Colombia - Peso")){
            cambio=1131.90;
        }
        ...
        else if(divisa1.equals("Colombia - Peso") && divisa2.equals("Perú - Nuevo Sol")){
            cambio=0.00089;
        }
        else if(divisa1.equals("Colombia - Peso") && divisa2.equals("Europa - Euro")){
            cambio=0.00022;
        }
        ...
        else if(divisa1.equals("Europa - Euro") && divisa2.equals("Colombia - Peso")){
            cambio=4462.79;
        }
    }
    /**
